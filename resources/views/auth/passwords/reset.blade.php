    ...
    <div class="con">
        ...
        <div class="signin-signup">
          ...
          <form method="POST" action="{{ route('password.update') }}" class="sign-in-form">
            ...
            <div class="form-group mb-2">
                <input type="email" name="email" class=" form-control @error('email') is-invalid @enderror" placeholder="Email" value="{{ $email ?? old('email') }}" autofocus>
                @error('email')
            ...
            <button type="submit" class="btne solid" style="width: 70%"> Reset Password</button>            
          </form>
      ...
      <div class="panels-con" >
        <div class="panel left-panel">
          ...
          <img src="{{asset('images/undraw_security_on_re_e491.svg')}}" style="margin-top: -70px;" class="image" alt="" />
        </div>
      </div>
    </div>
