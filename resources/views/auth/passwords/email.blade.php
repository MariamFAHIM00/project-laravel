    ...
    <div class="con">
      <div class="forms-con">
        <div class="signin-signup">
          <form method="POST" action="{{ route('password.email') }}" class="sign-in-form">
            ...
            <button type="submit" class="btne solid" style="width: 70%"> Send Password Reset Link</button>
            <p><small class="mt-4 mb-3"><a href=" {{route('login')}}" style="text-decoration:none; color:black"><i class="fa fa-arrow-left"></i>  Back to login page</a></small></p>
      ...
      <div class="panels-con" >
        <div class="panel left-panel">
          ...
          <img src="{{asset('images/undraw_forgot_password_re_hxwm (2).svg')}}" style="margin-top: -70px;" class="image" alt="" />
        </div>
      </div>
    </div>
